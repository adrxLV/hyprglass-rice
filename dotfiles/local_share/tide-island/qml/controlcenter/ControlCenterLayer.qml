            ...
            Row {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        border.color: isCharging ? StyleTokens.success : StyleTokens.textSecondary
                        border.width: 1
                        ...
                        Rectangle {
                            ...
                            anchors.margins: 2
                            radius: 2
                            width: isCharging ? (parent.width - 4) : Math.max(2, (parent.width - 4) * (batteryCapacity / 100.0))
                            color: {
                        ...
                        // Centered macOS-style charging lightning bolt icon
                        Text {
                    ...
                    Rectangle {
                        ...
                        height: 6
                        radius: 1
                        color: isCharging ? StyleTokens.success : StyleTokens.textSecondary
                        anchors.right: parent.right
                        anchors.verticalCenter: parent.verticalCenter
                    }
                }
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        anchors.fill: parent
                        radius: 13
                        color: powerBtnMouse.containsMouse ? StyleTokens.cardFillHover : StyleTokens.transparent
                        ...
                        Text {
                            ...
                            font.family: iconFontFamily
                            font.pixelSize: 13
                            color: powerBtnMouse.containsMouse ? "#e06c75" : StyleTokens.textPrimary
                        }
