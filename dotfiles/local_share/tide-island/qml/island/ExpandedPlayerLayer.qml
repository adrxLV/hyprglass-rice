                ...
                Column {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            // Previous Track (Double eb6f left triangles touching physically)
                            Item {
                                width: 38
                                height: 38
                                scale: prevArea.pressed ? 0.85 : (prevArea.containsMouse ? 1.08 : 1.0)
                                ...
                                Row {
                                    ...
                                    Text {
                                        text: ""
                                        font.family: root.iconFontFamily !== "" ? root.iconFontFamily : root.textFontFamily
                                        font.pixelSize: 20
                                        color: prevArea.pressed ? "#aaaaaa" : "#ffffff"
                                    }
                                    Text {
                                        text: ""
                                        font.family: root.iconFontFamily !== "" ? root.iconFontFamily : root.textFontFamily
                            ...
                            // Play / Pause Track (Apple style: circle appears ONLY on click and fades out)
                            Item {
                                width: 38
                                height: 38
                                scale: playArea.pressed ? 0.88 : (playArea.containsMouse ? 1.05 : 1.0)

                                Behavior on scale {
                                    NumberAnimation { duration: 140; easing.type: Easing.OutCubic }
                                }

                                // Click-flash circle backdrop
                                Rectangle {
                                    anchors.fill: parent
                                    radius: 19
                                    color: StyleTokens.cardFillActive
                                    opacity: playArea.pressed ? 1.0 : 0.0

                                    Behavior on opacity {
                                        NumberAnimation {
                                            duration: playArea.pressed ? 50 : 350
                                            easing.type: Easing.OutCubic
                                        }
                                    }
                                }
                                ...
                                Text {
                                    anchors.centerIn: parent
                                    anchors.horizontalCenterOffset: (activePlayer && activePlayer.playbackState === MprisPlaybackState.Playing) ? 0 : 1.5
                                    text: (activePlayer && activePlayer.playbackState === MprisPlaybackState.Playing) ? "" : ""
                                    font.family: root.iconFontFamily !== "" ? root.iconFontFamily : root.textFontFamily
                                    font.pixelSize: 22
                                    color: playArea.pressed ? "#aaaaaa" : "#ffffff"
                                }
                            ...
                            // Next Track (Double eb70 right triangles touching physically)
                            Item {
                                width: 38
                                height: 38
                                scale: nextArea.pressed ? 0.85 : (nextArea.containsMouse ? 1.08 : 1.0)
                                ...
                                Row {
                                    ...
                                    Text {
                                        ...
                                        font.family: root.iconFontFamily !== "" ? root.iconFontFamily : root.textFontFamily
                                        font.pixelSize: 20
                                        color: nextArea.pressed ? "#aaaaaa" : "#ffffff"
                                    }
                                    Text {
                                        text: ""
                                        font.family: root.iconFontFamily !== "" ? root.iconFontFamily : root.textFontFamily
