...
Scope {
    ...
    IpcHandler {
        ...
        function toggleToolsMenu() {
            shellRoot.forFocusedWindow((window) => window.toggleToolsMenuWindow());
        }
        ...
        function toggleAgentVoice() {
            shellRoot.forFocusedWindow((window) => window.toggleAgentVoiceWindow());
        }

        function toggleAgentText() {
            shellRoot.forFocusedWindow((window) => window.toggleAgentTextWindow());
        }
    }
    ...
    IpcHandler {
        ...
        function show() {
            shellRoot.forFocusedWindow((window) => window.showAgentVoiceWindow());
        }
    }
    ...
    IpcHandler {
        ...
        function show() {
            shellRoot.forFocusedWindow((window) => window.showAgentTextWindow());
        }
    }
    ...
    IpcHandler {
        ...
        function show() {
            shellRoot.forFocusedWindow((window) => window.showClipboardWindow());
        }
    }
    ...
    IpcHandler {
        ...
        function show() {
            shellRoot.forFocusedWindow((window) => window.showCalculatorWindow());
        }
    }
